...
private:
  ...
  bool _isPointerAtMax = false;
  bool _isPointerAtMin = false;
public:
  ///////////////////////
  // get ans set methods
  ///////////////////////
  ...
  /** @brief sets the minimum Pointer to the default value */
  ...
  /*@brief toggle if new factors or not*/
  ...
  bool getIntensityOrPointerAtMin(void);

  /**@return _intensityAtMax*/
  bool getIntensityOrPointerAtMax(void);
